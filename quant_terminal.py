...
# Sector impact weights: how strongly each event type affects each sector
# Scale: -2 (strongly negative) to +2 (strongly positive)
CLIMATE_IMPACT_MATRIX = {
    #                           Pharma  AIEnergy  Grid  Optical  Cyber  Climate
...
SECTOR_ORDER = ['Pharma & Biotech','AI Energy Infrastructure','Power Grid & Hardware',
                'Optical & Data Interconnect','Cybersecurity','Climate Resilience']
